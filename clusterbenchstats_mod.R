...
cqcluster.stats <- function (d = NULL, clustering, alt.clustering = NULL,
                             noisecluster = FALSE, 
                             silhouette = TRUE, G2 = FALSE, G3 = FALSE, wgap = TRUE, sepindex = FALSE, 
                             sepprob = 0.1, sepwithnoise = TRUE, compareonly = FALSE, 
                             aggregateonly = FALSE,
                             # new:                             
                             averagegap=FALSE, pamcrit=FALSE,
                             #                             densityindex=TRUE,
                             dquantile=0.1,
                             nndist=FALSE, nnk=2, standardisation="max", sepall=TRUE, maxk=10,
